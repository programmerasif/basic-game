                  ...
                  <div className="space-y-4 text-left max-w-md mx-auto text-green-200 mb-8">
                    <div>
                      <h3 className="text-xl font-bold text-white mb-2">
                        {String.fromCharCode(0x2192)} ধাপ ১ : ধর্ষক গুপ্ত
                      </h3>
                      <p className="text-sm">
                        ১০ টি ধর্ষক গুপ্তকে ধরলে , পরের স্টেজ হবে খুনি গুপ্ত। 
                      </p>
                    </div>
                    <div>
                      <h3 className="text-xl font-bold text-white mb-2">
                        {String.fromCharCode(0x2192)} ধাপ ২ : খুনি গুপ্ত
                      </h3>
                      <p className="text-sm">
                        ১০ টি খুনি গুপ্তকে ধরলে , পরের স্টেজ হবে রাজাকার গুপ্ত। 
                      </p>
                    </div>
                    <div>
                      <h3 className="text-xl font-bold text-white mb-2">
                        {String.fromCharCode(0x2192)} ধাপ ৩ : রাজাকার গুপ্ত
                      </h3>
                      <p className="text-sm">
                        ১০ টি রাজাকার গুপ্তকে ধরলে , পরের স্টেজ হবে রগকাটা-সন্ত্রাসি গুপ্ত।
                      </p>
                    </div>
                    <div>
                      <h3 className="text-xl font-bold text-white mb-2">
                        {String.fromCharCode(0x2192)} ধাপ ৪ : রগকাটা-সন্ত্রাসি গুপ্ত
                      </h3>
                      <p className="text-sm">
                        ১০ টি রগকাটা-সন্ত্রাসি গুপ্তকে ধরলে , পরের স্টেজ হবে চাঁদাবাজ গুপ্ত। 
                      </p>
                    </div>
                    <div>
                      <h3 className="text-xl font-bold text-white mb-2">
                        {String.fromCharCode(0x2192)} ধাপ ৫ : চাঁদাবাজ গুপ্ত
                      </h3>
                      <p className="text-sm">
                        ১০ টি ধর্ষক গুপ্তকে ধরলে win করে গেম শেষ করুন।  
                      </p>
                    </div>
                  </div>
                  <button
